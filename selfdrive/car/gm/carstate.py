...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, loopback_cp, frogpilot_toggles):
    ...
    if self.CP.enableGasInterceptor:
      ...
      threshold = 20 if self.CP.carFingerprint in CAMERA_ACC_CAR else 4 # Panda 595 threshold = 23.65. Set lower to avoid panda blocking messages and GasInterceptor faulting.
